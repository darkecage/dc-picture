...
import static com.darkecage.dcpicturebackend.constant.UserConstant.USER_LOGIN_STATE;
...
public class StpInterfaceImpl implements StpInterface {
    ...
    /**
     * @title: 返回一个账号所拥有的权限码集合
     * @author: darkecage
     * @date: 2025/5/24 21:45
     * @param: loginId
     * @param: loginType
    ...
    /**
     * @title: 返回一个账号所拥有的角色标识集合（权限与角色可分开校验），本项目中不使用
     * @author: darkecage
     * @date: 2025/5/24 21:45
     * @param: loginId
     * @param: loginType
